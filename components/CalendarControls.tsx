...
export const CalendarControls = () => {
    ...
    return (
        <div className="flex flex-col gap-8">
            <div className="flex flex-wrap items-center gap-6 justify-between bg-white p-6 rounded-[2rem] border border-[#dadce0] shadow-sm">
                <div className="flex flex-wrap items-center gap-8">
                    ...
                    <div className="flex bg-[#f1f3f4] p-1 rounded-full border border-[#dadce0]">
                        {(['day', 'month'] as const).map((mode) => (
                            <button
                                ...
                                className={`px-6 py-2 rounded-full font-medium text-sm transition-all duration-200 ${viewMode === mode
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex items-center border border-[#dadce0] rounded-full px-4 py-2 hover:bg-[#f8f9fa] transition-colors">
                            <select
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-5 py-2.5 rounded-full border text-sm font-medium transition-all ${showNativeScript
                            ? 'bg-[#e8f0fe] border-[#1a73e8] text-[#1a73e8]'
                            : 'bg-white border-[#dadce0] text-[#5f6368] hover:bg-[#f8f9fa]'
                            }`}
                    >
                        <div className={`w-3 h-3 rounded-full border-2 transition-all ${showNativeScript
